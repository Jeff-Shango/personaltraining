  ...
  return (
    <>
      <div className="programTitleContainer">
        ...
        {/* quick link buttons */}
    <button className={`custom-button ${isVisibleRight ? 'visible' : 'hidden'}`} onClick={() => {window.location.href='/programs#programsTitle';}} id="floatingButtonRight" style={{cursor: "pointer", opacity: isVisibleRight ? 1 : 0.2, zIndex:9999, display: isVisibleRight ? "block" : "none"}}>
      Go to Top
    </button>
      ...
      <div className="programsContainer">
        ...
        <div id='programPicContainer' className='programPicContainerA' style={{ cursor: "pointer"}} onClick={() => {window.location.href='/products';}}/>
      </div>
      ...
      <div className="programsContainer">
        ...
        <div id='programPicContainer' className='programPicContainerB' style={{ cursor: "pointer"}} onClick={() => {window.location.href='/products';}}/>
      </div>
      ...
      <div className="programsContainer">
        ...
        <div id='programPicContainer' className='programPicContainerC' style={{ cursor: "pointer"}} onClick={() => {window.location.href='/products';}}/>
      </div>
