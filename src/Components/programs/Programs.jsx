  ...
  return (
    <>
      ...
      <div className="programsContainer">
        ...
        <p className={`programDescription ${isExpanded ? 'expanded' : ''}`}>
        ...
        <h3><button id='viewMoreButton' onClick={toggleExpand}>{isExpanded ? 'view less' : 'view more'}</button></h3> 
        <div id='programPicContainer' className='programPicContainerA'/>
      </div>
      ...
      <div className="programsContainer">
        ...
        <div id='programPicContainer' className='programPicContainerB'/>
      </div>
